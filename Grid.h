...
public:
	...
	// ========= Other Getters =========
	Ladder* hasLadder(const CellPosition* C);
	Snake* hasSnake(const CellPosition* C);
	Card* hasCard(const CellPosition* C);
	bool emptyCell(const CellPosition* C);
	...
	void setcurrPlayerNumber(int number);
	Player* leastPlayer();
	...
	Player* GetNextPlayer(Player* CurrentPlayer, const CellPosition& position);
